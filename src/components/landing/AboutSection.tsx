...
const AboutSection = () => {
  return (
    <section id="about" className="py-20 bg-gradient-to-br from-purple-50 via-blue-50 to-yellow-50">
          ...
          <div className="space-y-6">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
              ...
              <p className="text-gray-600 leading-relaxed">
                Menciptakan pengalaman fotografi yang tidak hanya menghasilkan gambar yang indah, 
                tetapi juga membantu setiap klien mengekspresikan kepribadian unik mereka dengan percaya diri.
              </p>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
              ...
              <p className="text-gray-600 leading-relaxed">
                Dengan peralatan professional, tim kreatif yang berpengalaman, dan understanding terhadap 
                tren Gen Z, kami menjamin setiap sesi foto akan menghasilkan karya yang stunning dan authentic!
              </p>
            </div>
          </div>
        ...
        <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl">
          <CardContent className="p-12">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h3 className="text-3xl font-bold text-gray-800 mb-6">Visit Our Studio</h3>
              ...
              <div className="bg-gradient-to-br from-purple-100 to-blue-100 rounded-2xl p-8 text-center">
                ...
                <h4 className="text-xl font-bold text-gray-800 mb-2">Studio Location</h4>
