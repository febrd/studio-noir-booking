...
const OnlineBookingsReport = () => {
  ...
  // Query untuk mengambil semua transaksi dengan payment method online
  const { data: transactionsData, isLoading } = useQuery({
    queryKey: ['online-transactions', startDate, endDate],
    queryFn: async () => {
      console.log('Fetching online transactions...');
      
      // Ambil semua booking dengan payment method online
      ...
      console.log('Fetched online bookings:', bookings);

      // Ambil semua installments dengan payment method online
      ...
      // Tambahkan semua installment online
      ...
      console.log('All online transactions processed:', allTransactions);
  ...
  const exportData = useMemo(() => {
    ...
    return {
      title: `Laporan Transaksi Online (${startDate} - ${endDate})`,
      headers,
      data,
      filename: `transaksi-online-${startDate}-${endDate}`
    };
