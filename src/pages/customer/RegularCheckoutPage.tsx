...
const RegularCheckoutPage = () => {
  ...
  const packageType = booking?.package_type === 'regular' ? 'Regular Package' : 'Self Photo Package';

  return (
    <ModernLayout>
      <div className="container mx-auto p-6 max-w-4xl">
        <div className="mb-6">
          <h1 className="text-3xl font-bold tracking-tight">Checkout - Regular Package</h1>
