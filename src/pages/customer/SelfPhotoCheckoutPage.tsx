...
import { ArrowLeft, Plus, Minus, Clock, Users, MapPin } from 'lucide-react';
...
const SelfPhotoCheckoutPage = () => {
  ...
  const calculateTotal = () => {
    const packageTotal = (packageData?.price || 0) * quantity;
        ...
        {!showAdditionalServices ? (
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-3xl font-peace-sans font-black text-black">
                      {((packageData.price * quantity)).toLocaleString('id-ID', { 
                        style: 'currency', 
                        currency: 'IDR', 
          ...
          <div className="space-y-12">
            <div className="text-center">
              ...
              <p className="text-lg font-inter text-gray-500">Enhance your experience</p>
            </div>
