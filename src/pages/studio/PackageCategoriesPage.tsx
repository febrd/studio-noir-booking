    ...
    <div className="space-y-6">
      ...
      {categories?.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-4">Mulai dengan menambahkan kategori paket pertama</p>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              Tindakan ini tidak dapat dibatalkan dan akan menghapus semua paket dalam kategori ini.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
